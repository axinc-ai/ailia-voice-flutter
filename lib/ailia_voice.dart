...
class ailiaVoiceFFI {
  ...
  int ailiaVoiceOpenDictionaryFileA(
    ...
    ffi.Pointer<ffi.Int8> dictionary_path,
    int dictionary_type,
  ) {
  ...
  late final _ailiaVoiceOpenDictionaryFileAPtr = _lookup<
      ffi.NativeFunction<
          ffi.Int32 Function(ffi.Pointer<AILIAVoice>, ffi.Pointer<ffi.Int8>,
              ffi.Int32)>>('ailiaVoiceOpenDictionaryFileA');
  late final _ailiaVoiceOpenDictionaryFileA =
      _ailiaVoiceOpenDictionaryFileAPtr.asFunction<
          int Function(ffi.Pointer<AILIAVoice>, ffi.Pointer<ffi.Int8>, int)>();
  ...
  int ailiaVoiceOpenDictionaryFileW(
    ffi.Pointer<AILIAVoice> net,
    ffi.Pointer<wchar_t> dictionary_path,
    int dictionary_type,
  ) {
  ...
  late final _ailiaVoiceOpenDictionaryFileWPtr = _lookup<
      ffi.NativeFunction<
          ffi.Int32 Function(ffi.Pointer<AILIAVoice>, ffi.Pointer<wchar_t>,
              ffi.Int32)>>('ailiaVoiceOpenDictionaryFileW');
  late final _ailiaVoiceOpenDictionaryFileW =
      _ailiaVoiceOpenDictionaryFileWPtr.asFunction<
          int Function(ffi.Pointer<AILIAVoice>, ffi.Pointer<wchar_t>, int)>();
  ...
  /// @param postnet onnxファイルのパス名(MBSC)
  /// @param waveglow onnxファイルのパス名(MBSC)
  ...
  /// @param postnet The path name to the onnx file (MBSC)
  /// @param waveglow The path name to the onnx file (MBSC)
  /// @param model_type AILIA_VOICE_MODEL_TYPE_*
  /// @param cleaner_type AILIA_VOICE_CLEANER_TYPE_*
  /// @return
  /// If this function is successful, it returns  \ref AILIA_STATUS_SUCCESS , or an error code otherwise.
  int ailiaVoiceOpenModelFileA(
    ffi.Pointer<AILIAVoice> net,
    ffi.Pointer<ffi.Int8> encoder,
    ffi.Pointer<ffi.Int8> decoder,
    ffi.Pointer<ffi.Int8> postnet,
    ffi.Pointer<ffi.Int8> waveglow,
    int model_type,
    int cleaner_type,
  ) {
  ...
  late final _ailiaVoiceOpenModelFileAPtr = _lookup<
      ffi.NativeFunction<
          ffi.Int32 Function(
              ...
              ffi.Pointer<ffi.Int8>,
              ffi.Int32,
              ffi.Int32)>>('ailiaVoiceOpenModelFileA');
  ...
  /// @param postnet onnxファイルのパス名(UTF16)
  /// @param waveglow onnxファイルのパス名(UTF16)
  /// @param model_type AILIA_VOICE_MODEL_TYPE_*
  /// @param cleaner_type AILIA_VOICE_CLEANER_TYPE_*
  /// @return
  /// 成功した場合は \ref AILIA_STATUS_SUCCESS 、そうでなければエラーコードを返す。
  ...
  /// @param postnet The path name to the onnx file (UTF16)
  /// @param waveglow The path name to the onnx file (UTF16)
  /// @param model_type AILIA_VOICE_MODEL_TYPE_*
  /// @param cleaner_type AILIA_VOICE_CLEANER_TYPE_*
  /// @return
  /// If this function is successful, it returns  \ref AILIA_STATUS_SUCCESS , or an error code otherwise.
  int ailiaVoiceOpenModelFileW(
    ffi.Pointer<AILIAVoice> net,
    ffi.Pointer<wchar_t> encoder,
    ffi.Pointer<wchar_t> decoder,
    ffi.Pointer<wchar_t> postnet,
    ffi.Pointer<wchar_t> waveglow,
    int model_type,
    int cleaner_type,
  ) {
  ...
  late final _ailiaVoiceOpenModelFileWPtr = _lookup<
      ffi.NativeFunction<
          ffi.Int32 Function(
              ...
              ffi.Pointer<wchar_t>,
              ffi.Int32,
              ffi.Int32)>>('ailiaVoiceOpenModelFileW');
  ...
  int ailiaVoiceGraphemeToPhoeneme(
    ffi.Pointer<AILIAVoice> net,
    ffi.Pointer<ffi.Int8> utf8,
    int post_process,
  ) {
    return _ailiaVoiceGraphemeToPhoeneme(
      net,
      utf8,
      post_process,
    );
  ...
  late final _ailiaVoiceGraphemeToPhoenemePtr = _lookup<
      ffi.NativeFunction<
          ffi.Int32 Function(ffi.Pointer<AILIAVoice>, ffi.Pointer<ffi.Int8>,
              ffi.Int32)>>('ailiaVoiceGraphemeToPhoeneme');
  late final _ailiaVoiceGraphemeToPhoeneme =
      _ailiaVoiceGraphemeToPhoenemePtr.asFunction<
          int Function(ffi.Pointer<AILIAVoice>, ffi.Pointer<ffi.Int8>, int)>();
  ...
  late final _ailiaVoiceExtractFullContextPtr = _lookup<
      ffi.NativeFunction<
          ffi.Int32 Function(ffi.Pointer<AILIAVoice>,
              ffi.Pointer<ffi.Int8>)>>('ailiaVoiceExtractFullContext');
  late final _ailiaVoiceExtractFullContext =
      _ailiaVoiceExtractFullContextPtr.asFunction<
          int Function(ffi.Pointer<AILIAVoice>, ffi.Pointer<ffi.Int8>)>();
  ...
  late final _ailiaVoiceGetFeatureLengthPtr = _lookup<
      ffi.NativeFunction<
          ffi.Int32 Function(ffi.Pointer<AILIAVoice>,
              ffi.Pointer<ffi.Uint32>)>>('ailiaVoiceGetFeatureLength');
  late final _ailiaVoiceGetFeatureLength =
      _ailiaVoiceGetFeatureLengthPtr.asFunction<
          int Function(ffi.Pointer<AILIAVoice>, ffi.Pointer<ffi.Uint32>)>();
  ...
  /// 成功した場合は \ref AILIA_STATUS_SUCCESS 、そうでなければエラーコードを返す。
  /// @details
  /// ailiaVoiceGraphemeToPhoeneme() もしくは ailiaVoiceExtractFullContext() を一度も実行していない場合は \ref AILIA_STATUS_INVALID_STATE が返ります。
  ///
  /// \~english
  ...
  /// If this function is successful, it returns  \ref AILIA_STATUS_SUCCESS , or an error code otherwise.
  /// @details
  /// If  ailiaVoiceGraphemeToPhoeneme()  or ailiaVoiceExtractFullContext() is not run at all, the function returns  \ref AILIA_STATUS_INVALID_STATE .
  int ailiaVoiceGetFeatures(
    ffi.Pointer<AILIAVoice> net,
    ffi.Pointer<ffi.Int8> features,
    int len,
  ) {
  ...
  late final _ailiaVoiceGetFeaturesPtr = _lookup<
      ffi.NativeFunction<
          ffi.Int32 Function(ffi.Pointer<AILIAVoice>, ffi.Pointer<ffi.Int8>,
              ffi.Uint32)>>('ailiaVoiceGetFeatures');
  ...
  /// If this function is successful, it returns  \ref AILIA_STATUS_SUCCESS , or an error code otherwise.
  /// @details
  /// Get the result with ailiaVoiceGetWaves API.
  ...
  late final _ailiaVoiceInferencePtr = _lookup<
      ffi.NativeFunction<
          ffi.Int32 Function(ffi.Pointer<AILIAVoice>,
              ffi.Pointer<ffi.Int8>)>>('ailiaVoiceInference');
  ...
  int ailiaVoiceGetWaveInfo(
    ...
    ffi.Pointer<ffi.Uint32> sampling_rate,
  ) {
  ...
  late final _ailiaVoiceGetWaveInfoPtr = _lookup<
      ffi.NativeFunction<
          ffi.Int32 Function(
              ...
              ffi.Pointer<ffi.Uint32>,
              ffi.Pointer<ffi.Uint32>)>>('ailiaVoiceGetWaveInfo');
  ...
  int ailiaVoiceGetWaves(
    ffi.Pointer<AILIAVoice> net,
    ffi.Pointer<ffi.Float> buf,
    int buf_size,
  ) {
    return _ailiaVoiceGetWaves(
      net,
      buf,
      buf_size,
    );
  ...
  late final _ailiaVoiceGetWavesPtr = _lookup<
      ffi.NativeFunction<
          ffi.Int32 Function(ffi.Pointer<AILIAVoice>, ffi.Pointer<ffi.Float>,
              ffi.Uint32)>>('ailiaVoiceGetWaves');
  late final _ailiaVoiceGetWaves = _ailiaVoiceGetWavesPtr.asFunction<
  ...
  ffi.Pointer<ffi.Int8> ailiaVoiceGetErrorDetail(
    ffi.Pointer<AILIAVoice> net,
  ) {
  ...
  late final _ailiaVoiceGetErrorDetail = _ailiaVoiceGetErrorDetailPtr
      .asFunction<ffi.Pointer<ffi.Int8> Function(ffi.Pointer<AILIAVoice>)>();
}
...
typedef AILIA_VOICE_USER_API_AILIA_CREATE = ffi.Pointer<
    ffi.NativeFunction<
        ffi.Int32 Function(
            ffi.Pointer<ffi.Pointer<AILIANetwork>>, ffi.Int32, ffi.Int32)>>;
...
typedef AILIA_VOICE_USER_API_AILIA_OPEN_WEIGHT_FILE_W = ffi.Pointer<
    ffi.NativeFunction<
        ffi.Int32 Function(ffi.Pointer<AILIANetwork>, ffi.Pointer<wchar_t>)>>;
typedef AILIA_VOICE_USER_API_AILIA_OPEN_WEIGHT_MEM = ffi.Pointer<
    ffi.NativeFunction<
        ffi.Int32 Function(
            ffi.Pointer<AILIANetwork>, ffi.Pointer<ffi.Void>, ffi.Uint32)>>;
typedef AILIA_VOICE_USER_API_AILIA_SET_MEMORY_MODE = ffi.Pointer<
    ffi
    .NativeFunction<ffi.Int32 Function(ffi.Pointer<AILIANetwork>, ffi.Uint32)>>;
...
typedef AILIA_VOICE_USER_API_AILIA_UPDATE = ffi
    .Pointer<ffi.NativeFunction<ffi.Int32 Function(ffi.Pointer<AILIANetwork>)>>;
typedef AILIA_VOICE_USER_API_AILIA_GET_BLOB_INDEX_BY_INPUT_INDEX = ffi.Pointer<
    ffi.NativeFunction<
        ffi.Int32 Function(
            ffi.Pointer<AILIANetwork>, ffi.Pointer<ffi.Uint32>, ffi.Uint32)>>;
...
typedef AILIA_VOICE_USER_API_AILIA_GET_ERROR_DETAIL = ffi.Pointer<
    ffi
    .NativeFunction<ffi.Pointer<ffi.Int8> Function(ffi.Pointer<AILIANetwork>)>>;
...
const int AILIA_VOICE_TEXT_POST_PROCESS_PAU_TO_CAMMA = 1;

const int AILIA_VOICE_TEXT_POST_PROCESS_REMOVE_SPACE = 2;

const int AILIA_VOICE_TEXT_POST_PROCESS_APPEND_PERIOD = 4;

const int AILIA_VOICE_TEXT_POST_PROCESS_APPEND_ACCENT = 8;
